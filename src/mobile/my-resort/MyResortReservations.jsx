...
import { addWalletTransaction, createNotification, db, updateWalletBalance } from '../../firebase'
...
const MyResortReservations = () => {
  ...
  const handleRefund = async (bookingId, booking) => {
    if (!confirm('Are you sure you want to process a refund for this reservation?')) return
    ...
    return (
      <div className="mres-container">
        <header className="mres-header">
          <button className="mres-back" onClick={() => navigate('/my-resort/dashboard')}><i className="fas fa-chevron-left"></i></button>
          <h1>Reservations</h1>
          <div style={{ width: 40 }}></div>
        </header>
        <main className="mres-main"><div className="mres-empty">Loading reservations...</div></main>
        <BottomNav />
      </div>
    )
  }
      ...
      <main className="mres-main">
        ...
        {bookings.length > 0 ? (
              ...
              <div key={booking.id} className="mres-card">
                <div className="mres-card-header">
                  <div className="mres-guest-info">
                    <div className="mres-guest-avatar"><i className="fas fa-user"></i></div>
                  ...
                  <div className="mres-detail-grid">
                    <div className="mres-detail">
                      ...
                      <div>
                        ...
                        <span className="mres-value">{booking.room?.title || 'N/A'}</span>
                      </div>
                    </div>
                    ...
                    <div className="mres-detail">
                      ...
                      <div>
                        ...
                        <span className="mres-value">{new Date(booking.checkIn).toLocaleDateString()}</span>
                      </div>
                    </div>
                    ...
                    <div className="mres-detail">
                      ...
                      <div>
                        ...
                        <span className="mres-value">{booking.nights || 1}</span>
                      </div>
                    </div>
                    ...
                    <div className="mres-detail">
                      ...
                      <div>
                        ...
                        <span className="mres-value">{booking.referenceNumber}</span>
                      </div>
                    </div>
                    ...
                    <div className="mres-detail">
                      ...
                      <div>
                        ...
                        <span className="mres-value">{formatPrice(getBookingAmount(booking))}</span>
                      </div>
                    </div>
                    ...
                    <div className="mres-detail">
                      ...
                      <div>
                        ...
                        <span className="mres-value">{formatPrice(booking.totalPrice)}</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="mres-card-actions">
                  <button
                    ...
                    disabled={refundingId === booking.id || getBookingState(booking) === 'refunded'}
                  >
          ...
          <div className="mres-empty">
            <div className="mres-empty-icon"><i className="fas fa-inbox"></i></div>
