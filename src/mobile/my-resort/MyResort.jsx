...
const MyResort = () => {
  ...
  useEffect(() => {
    ...
    const unsubscribe = onValue(applicationsRef, (snapshot) => {
      ...
      const applications = Object.entries(value).map(([id, item]) => ({
        id,
        ...item,
      }));
      ...
      setProfileForm({
        ...
        contactNumber:
          baseProfile.contactNumber || selected.contactNumber || "",
        email:
          baseProfile.email ||
          selected.email ||
          selected.ownerEmail ||
    ...
    return (
      <div className="mrm-container">
        <header className="mrm-header">
          <button className="mrm-back" onClick={() => navigate("/profile")}>
        ...
        <main className="mrm-main">
          <div className="mrm-empty">Loading resort...</div>
        </main>
        <BottomNav />
      </div>
    );
      ...
      <div className="mrm-container">
        ...
        <main className="mrm-main">
          <div className="mrm-empty">
            ...
            <button onClick={() => navigate("/register-resort")}>
              Register Resort
            </button>
          </div>
        </main>
    ...
    <div className="mrm-container">
      <header className="mrm-header">
        ...
        <div className="mrm-header-actions">
          <button
            className="mrm-header-btn mrm-dashboard-btn"
            onClick={() => navigate("/my-resort/dashboard")}
            title="Admin Dashboard"
          >
            <i className="fas fa-chart-line"></i>
          </button>
          <button className="mrm-save" onClick={saveProfile} disabled={saving}>
            {saving ? "..." : "Save"}
          </button>
        </div>
      </header>
      ...
      <main className="mrm-main">
        ...
        {message && (
          <div
            className={`mrm-message ${messageType === "error" ? "is-error" : ""}`}
          >
            {message}
          </div>
        )}
        ...
        <section className="mrm-card">
          ...
          <p className="mrm-card-subtitle">
            Set your visible resort details and showcase image.
          </p>

          <div
            className="mrm-main-photo-box"
          ...
          <div className="mrm-upload-row">
            ...
            <button
              ...
              style={
                mainPhotoFile ? { background: "#0a84ff", color: "#fff" } : {}
              }
            >
              {uploadingMain ? (
          ...
          <div className="mrm-profile-fields">
            <input
              value={profileForm.resortName}
              onChange={(e) =>
                setProfileForm((p) => ({ ...p, resortName: e.target.value }))
              }
            ...
            <input
              ...
              onChange={(e) =>
                setProfileForm((p) => ({ ...p, contactNumber: e.target.value }))
              }
            ...
            <div className="mrm-entrance-fee-block">
              <div className="mrm-entrance-fee-label">
                ...
                <div>
                  <span className="mrm-entrance-fee-title">
                    Entrance Fee / Day Tour Rate
                  </span>
                  <span className="mrm-entrance-fee-hint">
                    Shown to guests as the Day Tour price per person
                  </span>
                </div>
              </div>
              <div className="mrm-entrance-fee-input-row">
                ...
                <input
                  ...
                  onChange={(e) =>
                    setProfileForm((p) => ({
                      ...p,
                      entranceFee: e.target.value.replace(/[^0-9.]/g, ""),
                    }))
                  }
                  placeholder="0.00"
                  type="number"
            ...
            <div className="mrm-address-row">
              ...
              >
                <i
                  className={`fas ${profileForm.latitude ? "fa-map-marker-alt" : "fa-map-marked-alt"}`}
                ></i>
        ...
        <section className="mrm-card">
          ...
          <p className="mrm-card-subtitle">
            Toggle each section to control your public resort page.
          </p>
        ...
        <section className="mrm-card">
          ...
          <p className="mrm-card-subtitle">
            Set a percentage discount off the entrance fee per guest type
            (0–100). Leave blank for no discount.
          </p>
            ...
            {[
              ...
              <div key={key} className="mrm-discount-item">
                ...
                <div className="mrm-discount-input-wrap">
                  ...
                  />
                  <span className="mrm-discount-pct">% off / guest</span>
                </div>
              </div>
            ))}
          </div>
          <button
            className="mrm-save mrm-discount-save"
            onClick={saveProfile}
            disabled={saving}
          >
        ...
        <section className="mrm-card">
          ...
          <p className="mrm-card-subtitle">
            Open a dedicated screen to manage each section.
          </p>
          <div className="mrm-action-grid">
            <button
              className="mrm-action-card"
              type="button"
              onClick={() => navigate("/my-resort/rooms")}
            >
              <div
                style={{ display: "flex", alignItems: "center", gap: "14px" }}
              >
                <div className="mrm-action-icon">
            ...
            <button
              className="mrm-action-card"
              type="button"
              onClick={() => navigate("/my-resort/activities")}
            >
              <div
                style={{ display: "flex", alignItems: "center", gap: "14px" }}
              >
            ...
            <button
              className="mrm-action-card"
              type="button"
              onClick={() => navigate("/my-resort/gallery")}
            >
              <div
                style={{ display: "flex", alignItems: "center", gap: "14px" }}
              >
